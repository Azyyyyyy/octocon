...
using Octocon.IntegrationTests.Replay;
using TUnit.Core;
...
public sealed class ReplayParityTests
{
        ...
        string fixtureFileName)
    {
        ...
        request.Headers.Add("X-Octocon-Dev-Principal", step.PrincipalId);

        if (!string.IsNullOrWhiteSpace(step.IdempotencyKey))
            request.Headers.Add("X-Octocon-Idempotency-Key", step.IdempotencyKey);
