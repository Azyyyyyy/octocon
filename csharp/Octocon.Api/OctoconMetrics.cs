...
/// Wire via <c>builder.Services.AddOpenTelemetry().WithMetrics(m => m.AddMeter("Octocon.Api"))</c>.
/// </summary>
public static class OctoconMetrics
{
    public static readonly string MeterName = "Octocon.Api";
